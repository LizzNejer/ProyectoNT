<html>
    ...
    <center>
            <style> body {background-color:#FDEBD0;}</style>   
				<img src="/imagenes/cli.jpg" width="110" height="100">
		<div class="title">
                    Registro de Cliente
                </div>
		...
		<table border="2px"> <!-- Lo cambiaremos por CSS -->
           <tr><td><center><label for="name" class="control-label">Ingrese Nombre: </label>
			<input type="text" name="nombre" /></center><br></td></tr>
			<tr><td>
			<center><label for="name" class="control-label">Ingrese Apellido: </label><br>
			<input type="text" name="apellido" /></center><br></td></tr>			
			<tr><td>
			<center><label for="name" class="control-label">Ingrese Cédula: </label><br>
			<input type="text" name="cedula" /></center></td></tr><br>
			<tr><td>
			<center><label for="name" class="control-label">Ingrese Correo: </label><br>
			<input type="text" name="correo" /></center></td></tr><br>
			<tr><td>
			<center><label for="name" class="control-label">Ingrese Telefono: </label><br>
			<input type="text" name="telefono" /></center><br></td>
			</tr><br>
        </table>
